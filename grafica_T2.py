...
# Los demas parametros  son opcionales y se pasan como banderas
...
data=np.loadtxt('division_mexico.dat')
...
dataset2=Dataset('../wrfout_c15d_d01_2014-01-01_00:00:00.2014')
lat=dataset2.variables['XLAT'][0,:]
long=dataset2.variables['XLONG'][0,:]
...
lat_n=lat[-1][0]		# Latitud norte
lat_s=lat[0][0]			# Latitud sur
long_e=long[0][-1]	# Longitud este
long_o=long[0][0]			# Longitud oeste
